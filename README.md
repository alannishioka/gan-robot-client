...
It justs turns the cube randomly 20 times and the reverses the order to get back where you started.
...
There is a V3 robot now (as well as a V2 robot), but I don't know the difference between them.
I also don't know if this code or anything like it will work on them.

https://github.com/rsimp/gan-scrambler
is a PWA that runs in a bluetooth enabled browser (chrome).  It is much more complete and includes a solver, but I couldn't get it to work.

u/poliva got it to work here: https://pof.eslack.org/gan-scrambler/
But it won't run in any of my browsers, so I don't know to much about it.
